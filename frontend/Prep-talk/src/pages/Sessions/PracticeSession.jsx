  ...
  return (
    <div className="min-h-screen bg-[#1a1d2e] text-white py-12 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Error Message */}
        {error && (
          <div className="mb-6 p-4 bg-yellow-500/10 rounded-xl backdrop-blur-sm">
        ...
        {!started ? (
          <div className="rounded-2xl bg-slate-800 p-12 text-center shadow-2xl">
            ...
            {questions.length > 0 ? (
              <div className="mb-8 p-5 bg-green-900/30 rounded-xl max-w-md mx-auto">
              ...
              <div className="mb-8 p-5 bg-red-900/30 rounded-xl max-w-md mx-auto">
          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                {currentQuestion ? (
                  <>
                    ...
                    {/* Navigation Controls */}
                    <div className="flex items-center justify-between gap-4 p-5 bg-slate-800 rounded-xl shadow-lg">
                      <button
                  ...
                  <div className="p-10 bg-slate-800 rounded-2xl text-center shadow-xl">
              ...
              {/* Sidebar */}
              <aside className="p-6 bg-slate-800 rounded-2xl h-fit shadow-xl sticky top-6">
                ...
                {result ? (
                  <div className="space-y-4">
                    <div className="p-4 bg-indigo-900/50 rounded-xl">
                ...
                <button
                  ...
                  className="w-full mt-6 px-4 py-3 bg-red-500/10 hover:bg-red-500/20 text-red-400 rounded-lg transition-all text-sm font-medium"
                >
                  🚪 Exit Session
                </button>
              </aside>
